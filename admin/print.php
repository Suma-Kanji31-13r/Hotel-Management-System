...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>MAKAUT VELA</p>
				<p>Kalyani-741245, <br>West Bengal,<br> India</p>
				<p>(+94) 65 222 44 55</p>
			</address>
			<span><img alt="" src="assets\img\f017321bfab7e48ef3f48b766562696c (1).png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@MAKAUT.com || Web :- www.makaut.com || Phone :- +94 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
